...
<div class="container-fluid intro2_wrap">
		...
		<div class="container intro2_d_margin_auto intro2_d_margin_top4">
			...
			<div class="col-md-6" style="height: 225px;">
				<div class="intro2_f_height intro2_text intro2_f_w intro2_size1 col-md-2">태</div>
				<div class="col-md-10" ><span class="glyphicon glyphicon-tags intro2_size4 g_color_red intro2_d_margin_top3 intro2_stick"></span></div>	
				<div class="col-md-12"> 
							<div class="intro2_f_height intro2_text intro2_tb intro2_f_w intro2_size1 col-md-2">그</div>	
						<div class="intro2_d_margin_top3 col-md-10">
							<div class="intro2_tb intro2_f_w intro2_size2 intro2_d_margin1">를 통해 <b>포스트</b>를 찾고</div>
							<div class="intro2_tb intro2_f_w intro2_size2 intro2_d_margin1">내 글에 추가해 보세요&nbsp;&nbsp;<span class="glyphicon glyphicon-paperclip intro2_size4" aria-hidden="true"></span></div>
						</div>
					</div>
			</div>
			...
			<div class="col-md-6 intro2_tb intro2_d_margin_top3">
			</div>
			<div class="col-md-3 intro2_tb"></div>
		</div>
